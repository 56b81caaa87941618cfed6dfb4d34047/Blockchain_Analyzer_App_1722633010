...
Vue.component("simple_header_component_1722633013", {
    ...
    <header id="header-section" class="w-full">
        <nav id="nav-bar" class="bg-gradient-to-r from-pink-400 to-purple-500 bg-opacity-30 backdrop-filter backdrop-blur-lg py-6 shadow-lg rounded-lg">
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-8 mx-auto">
                ...
                <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                    <ul id="nav-list" class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li id="nav-item-home"><a href="#" class="block py-2 px-4 text-white bg-purple-400 bg-opacity-50 rounded-lg lg:bg-transparent lg:text-white lg:p-0 hover:bg-pink-300 hover:bg-opacity-50 transition-all duration-300" aria-current="page">Latest Block Analysis</a></li>
                        <li id="nav-item-1"><a href="#" class="block py-2 px-4 text-white rounded-lg hover:bg-pink-300 hover:bg-opacity-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-pink-200 lg:p-0 transition-all duration-300">Transaction Volume Trends</a></li>
                        <li id="nav-item-2"><a href="#" class="block py-2 px-4 text-white rounded-lg hover:bg-pink-300 hover:bg-opacity-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-pink-200 lg:p-0 transition-all duration-300">Smart Contract Activity</a></li>
                        <li id="nav-item-3"><a href="#" class="block py-2 px-4 text-white rounded-lg hover:bg-pink-300 hover:bg-opacity-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-pink-200 lg:p-0 transition-all duration-300">Token Transfer Metrics</a></li>
                    </ul>
                </div>
            </div>
        </nav>
